...
fun Calculator(
    ...
    buttonSpacing: Dp= 8.dp , onAction:(CalculatorAction)->Unit
    ...
    Box(modifier = modifier)
    {
        ...
        )
        {
            ...
            modifier = Modifier
                ...
                .padding(32.dp),
                color = Color.White,
                textAlign = TextAlign.End, fontSize = 80.sp, fontWeight = FontWeight.Light, maxLines= 2
            ...
            Row(modifier= Modifier
                ...
                CalculatorButton(symbol = "/", modifier =Modifier
                    ...
                    onClick = {
                        ...
                        onAction(CalculatorAction.Operations(CalculatorOperation.division))
                    }
                )
